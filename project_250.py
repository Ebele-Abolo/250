...
transaction1 = blockchain.transaction("Sender","Receiver", '"Number of Ethereums" ETH')
transaction2 = blockchain.transaction("Sender","Receiver", '"Number of Ethereums" ETH')
